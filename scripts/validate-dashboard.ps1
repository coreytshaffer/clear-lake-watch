...
try {
  ...
  $publicMirrorFileSetDoc = Get-Content (Resolve-ProjectPath "docs\public-mirror-file-set-2026-05-08.md") -Raw
  ...
  Assert-TextContains -Text $backlog -Needle "Portfolio-safe release prep is in draft PR review" -Message "docs/backlog.md must track the current portfolio-safe release review state."
  ...
  Assert-TextContains -Text $backlog -Needle "docs/public-mirror-file-set-2026-05-08.md" -Message "docs/backlog.md must track the public mirror file set."
  Assert-TextContains -Text $backlog -Needle 'create a clean `main` candidate branch using the curated public mirror file set' -Message "docs/backlog.md must preserve the current public mirror decision point."
  ...
  Assert-TextContains -Text $portfolioReleaseBranchHandoffDoc -Needle "Draft PR #2" -Message "docs/portfolio-release-branch-handoff.md must document the draft PR review surface."
  Assert-TextContains -Text $portfolioReleaseBranchHandoffDoc -Needle "codex/portfolio-safe-release-base" -Message "docs/portfolio-release-branch-handoff.md must document the review-only base branch."
  Assert-TextContains -Text $portfolioReleaseBranchHandoffDoc -Needle "trusted review request and private feedback log" -Message "docs/portfolio-release-branch-handoff.md must document the trusted-review artifacts."
  ...
  Assert-TextContains -Text $portfolioSafeReleaseGateSummaryDoc -Needle "docs/public-mirror-file-set-2026-05-08.md" -Message "docs/portfolio-safe-release-gate-summary.md must point to the public mirror file set."
  ...
  Assert-TextContains -Text $publicationPushReviewDoc -Needle "draft PR opened against review-only base branch; public mirror not promoted" -Message "docs/publication-push-review-2026-05-07.md must document the draft PR review state."
  ...
  Assert-TextContains -Text $publicationPushReviewDoc -Needle "https://github.com/coreytshaffer/clear-lake-watch/pull/2" -Message "docs/publication-push-review-2026-05-07.md must link the draft PR review surface."
  Assert-TextContains -Text $publicationPushReviewDoc -Needle "codex/portfolio-safe-release-base" -Message "docs/publication-push-review-2026-05-07.md must document the review-only base branch."
  Assert-TextContains -Text $publicationPushReviewDoc -Needle 'not `main`' -Message "docs/publication-push-review-2026-05-07.md must document that the draft PR does not target main."
  ...
  Assert-TextContains -Text $conversationLog -Needle "Draft PR Review Surface And Trusted Feedback Path" -Message "docs/conversation-log.md must record the draft PR and trusted feedback checkpoint."
  Assert-TextContains -Text $conversationLog -Needle "historical note was superseded by the May 8 draft PR review checkpoint" -Message "docs/conversation-log.md must mark the old local-branch handoff note as superseded."
  Assert-TextContains -Text $conversationLog -Needle "https://github.com/coreytshaffer/clear-lake-watch/pull/2" -Message "docs/conversation-log.md must record the draft PR URL."
  Assert-TextContains -Text $conversationLog -Needle "codex/portfolio-safe-release-base" -Message "docs/conversation-log.md must record the review-only base branch."
  Assert-TextContains -Text $conversationLog -Needle "public mirror was not promoted" -Message "docs/conversation-log.md must preserve the no-public-promotion boundary."
  Assert-TextContains -Text $conversationLog -Needle "Trusted feedback must not be treated as official approval" -Message "docs/conversation-log.md must preserve the trusted-feedback no-endorsement boundary."
  ...
  Assert-TextContains -Text $publicMirrorFileSetDoc -Needle "Public Mirror File Set - 2026-05-08" -Message "docs/public-mirror-file-set-2026-05-08.md must define the public mirror file set."
  Assert-TextContains -Text $publicMirrorFileSetDoc -Needle "dashboard plus selected portfolio docs" -Message "docs/public-mirror-file-set-2026-05-08.md must record the recommended file-set choice."
  Assert-TextContains -Text $publicMirrorFileSetDoc -Needle 'Do not retarget Draft PR #2 to `main`.' -Message "docs/public-mirror-file-set-2026-05-08.md must preserve the no-retarget rule."
  Assert-TextContains -Text $publicMirrorFileSetDoc -Needle '`README.md`, after public-mirror trimming' -Message "docs/public-mirror-file-set-2026-05-08.md must require README trimming."
  Assert-TextContains -Text $publicMirrorFileSetDoc -Needle "public-mirror validator" -Message "docs/public-mirror-file-set-2026-05-08.md must require validator trimming or replacement."
  Assert-TextContains -Text $publicMirrorFileSetDoc -Needle "portfolio-materials.html" -Message "docs/public-mirror-file-set-2026-05-08.md must exclude the local portfolio index."
  Assert-TextContains -Text $publicMirrorFileSetDoc -Needle "docs/trusted-review-feedback-log.md" -Message "docs/public-mirror-file-set-2026-05-08.md must exclude the trusted feedback log."
  Assert-TextContains -Text $publicMirrorFileSetDoc -Needle "shortcuts/" -Message "docs/public-mirror-file-set-2026-05-08.md must exclude shortcut binaries."
  Assert-TextContains -Text $publicMirrorFileSetDoc -Needle "data/site-review.json" -Message "docs/public-mirror-file-set-2026-05-08.md must exclude the detailed site-review queue."
  Assert-TextContains -Text $publicMirrorFileSetDoc -Needle "Next slice: create a clean public mirror candidate branch" -Message "docs/public-mirror-file-set-2026-05-08.md must name the next branch-building slice."
  ...
  Assert-TextContains -Text $publicMirrorReviewDoc -Needle "docs/public-mirror-file-set-2026-05-08.md" -Message "docs/public-mirror-review-2026-05-08.md must point to the selected file set."
  ...
  Assert-TextContains -Text $publicationReviewChecklistDoc -Needle "docs/public-mirror-file-set-2026-05-08.md" -Message "docs/publication-review-checklist.md must point to the public mirror file set."
  ...
  Assert-TextContains -Text $publicationReviewChecklistDoc -Needle "Draft PR Review Surface Gate" -Message "docs/publication-review-checklist.md must include the draft PR review surface gate."
  Assert-TextContains -Text $publicationReviewChecklistDoc -Needle "Draft PR #2" -Message "docs/publication-review-checklist.md must name the draft PR review surface."
  Assert-TextContains -Text $publicationReviewChecklistDoc -Needle "codex/portfolio-safe-release-base" -Message "docs/publication-review-checklist.md must preserve the review-only base branch."
  Assert-TextContains -Text $publicationReviewChecklistDoc -Needle 'not `main`' -Message "docs/publication-review-checklist.md must preserve the not-main draft PR boundary."
  Assert-TextContains -Text $publicationReviewChecklistDoc -Needle "does not publish, promote, or refresh the public mirror" -Message "docs/publication-review-checklist.md must preserve the no-public-promotion draft PR boundary."
  Assert-TextContains -Text $publicationReviewChecklistDoc -Needle "docs/trusted-review-feedback-log.md" -Message "docs/publication-review-checklist.md must point to the trusted-review feedback log."
  Assert-TextContains -Text $publicationReviewChecklistDoc -Needle "portfolio-materials.html" -Message "docs/publication-review-checklist.md must point to the local portfolio index."
  ...
  Assert-TextContains -Text $deploymentDoc -Needle "portfolio-materials.html" -Message "docs/deployment.md must document the local portfolio materials index."
  Assert-TextContains -Text $deploymentDoc -Needle "Clear Lake Watch Portfolio Materials" -Message "docs/deployment.md must document the local portfolio materials shortcut."
  Assert-TextContains -Text $deploymentDoc -Needle "These shortcuts are local navigation aids only" -Message "docs/deployment.md must preserve the shortcut no-publication boundary."
