...
- `docs/career-services-day-of-checklist.md`, `docs/career-services-share-packet.md`, `docs/internship-share-brief.md`, `docs/career-services-call-notes.md`, `docs/internship-role-fit-map.md`, and `docs/resume-linkedin-snippets.md` provide a shareable internship packet for SNHU career services and similar conversations.
