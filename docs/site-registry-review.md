...
- Registry sites needing review: 9
...
| low | Jones Bay | Jones bay | Lower Arm | needs-local-review | alias | 0.14 km | September 4, 2025 | Alias and coordinates are close, but local review has not certified the assignment. | Confirm local landmark and arm assignment, then promote only if locally reviewed. |
