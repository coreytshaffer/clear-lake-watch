...
Clear Lake Watch is a watershed intelligence dashboard prototype for Clear Lake, California. It explores how public water-quality signals, hydrologic context, GIS data, source-status metadata, field-method planning, and review boundaries can be combined into a cautious public situational-awareness surface.

The project is not an official public-health tool, does not issue advisories, and should not be described as a deployed research-grade monitoring network. Its current research value is as a documented prototype for public environmental data integration, transparent uncertainty, and mentor-review-ready field-validation planning.
...
- Official method source spine that anchors future protocols to Lake County QAPP, EPA quality assurance, EPA lake-monitoring, and related California data-system sources.
- Secchi depth / clarity mentor-review protocol and handoff packet for bounded technical feedback before any field pilot decision.
...
- The Secchi depth / clarity protocol is mentor-review-only and does not authorize field work, public field-data exports, bloom diagnosis, toxin-risk estimates, or recreation-safety decisions.
...
| Field-method planning | Start future student-led validation from official method sources before collecting or publishing field observations. | Mentor feedback on the Secchi protocol, source anchors, metadata, QA/QC checks, and public wording limits. |
...
> Are the project’s source boundaries, review labels, planned validation steps, and Secchi depth / clarity mentor-review protocol scientifically reasonable for a student-led environmental monitoring prototype, and what should be corrected before any field testing or broader public promotion?

## Near-Term Work Plan

1. Keep the dashboard validator passing and preserve stale-source warnings as visible trust cues.
2. Keep portfolio-facing documents aligned with the current public mirror, official method source spine, and Secchi mentor-review packet.
...
4. Ask one environmental science, water-quality, GIS, or field-method mentor for feedback on the review labels, validation pathway, and Secchi protocol.
5. After feedback, decide whether to revise the Secchi packet, add official sources, or create a separate future private pilot design.
